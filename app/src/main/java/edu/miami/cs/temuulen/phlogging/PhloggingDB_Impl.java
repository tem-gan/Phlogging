    ...
    public SupportSQLiteOpenHelper createOpenHelper(DatabaseConfiguration configuration) {
        return configuration.sqliteOpenHelperFactory.create(SupportSQLiteOpenHelper.Configuration.builder(configuration.context).name(configuration.name).callback(new RoomOpenHelper(configuration, new RoomOpenHelper.Delegate(1) {
            ...
            public RoomOpenHelper.ValidationResult onValidateSchema(SupportSQLiteDatabase _db) {
                ...
                _columnsPhlogs.put("phlogsDB_title", new TableInfo.Column("phlogsDB_title", "TEXT", false, 0, (String) null, 1));
                _columnsPhlogs.put("phlogsDB_text", new TableInfo.Column("phlogsDB_text", "TEXT", false, 0, (String) null, 1));
                _columnsPhlogs.put("phlogsDB_uri", new TableInfo.Column("phlogsDB_uri", "TEXT", false, 0, (String) null, 1));
                _columnsPhlogs.put("phlogsDB_timestamp", new TableInfo.Column("phlogsDB_timestamp", "TEXT", false, 0, (String) null, 1));
                _columnsPhlogs.put("phlogsDB_latitude", new TableInfo.Column("phlogsDB_latitude", "REAL", true, 0, (String) null, 1));
                _columnsPhlogs.put("phlogsDB_longitude", new TableInfo.Column("phlogsDB_longitude", "REAL", true, 0, (String) null, 1));
                _columnsPhlogs.put("phlogsDB_text_location", new TableInfo.Column("phlogsDB_text_location", "TEXT", false, 0, (String) null, 1));
